...
#define SDL_INIT_EVERYTHING 255
...
void SDL_EnableUNICODE(bool b);

int getLanguage(void);
void setLanguage(int languageID);

const char* SDL_GetKeyName(u32 key);
...
int SDL_JoystickNumAxes(void * joystick);
...
#define SDLK_p 		KEY_Y //KEY_SELECT
...
#define SDLK_LCTRL	KEY_A //KEY_B
#define SDLK_ESCAPE	KEY_X
#define SDLK_LALT	KEY_B //KEY_START
...
#define SDL_OPENGL	32
#define SDL_SRCALPHA 64
#define SDL_RLEACCELOK	128
#define SDL_SRCCOLORKEY 256
#define SDL_HWACCEL 512
#define SDL_TOPSCREEN 1024
#define SDL_BOTTOMSCREEN 2048
...
#define MIX_INIT_OGG 32
#define MIX_DEFAULT_FORMAT 1
